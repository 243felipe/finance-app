...
@Component({
  selector: 'app-recorrentes-saidas-relatorio',
  standalone: true,
  imports: [CommonModule, FormsModule, TableModule, ButtonModule],
  templateUrl: './recorrentes-saidas-relatorio.component.html',
  styleUrls: ['./recorrentes-saidas-relatorio.component.scss']
})
export class RecorrentesSaidasRelatorioComponent implements OnInit {
  loading = false;
  ...
  pesquisar(): void {
    this.loading = true;
    this.service.listSaidas().subscribe({
      next: (data) => {
        this.dados = data;
        this.loading = false;
      },
  ...
  gerarPdf(): void {
    ...
    const titulo = `Relatório de Recorrentes - Saídas`;
